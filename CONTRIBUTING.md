...
some other ruleset that depends on rules_syft, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_syft=$(pwd)/rules_syft"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_syft` on your system will point to this folder.
